...
$sql = "UPDATE Allotment SET status = 'Rejected' Where Propertyid = '".($_SESSION['mm'])."' ";
//Executes the query
  ...
  require 'PHPMailer/PHPMailerAutoload.php';
    ...
    $mail->Body    = '<div style="width:100%;">
                  <div style="background-color:#eeeeee; width:80%; margin:0 auto; position:relative;">
                    ...
                    <div>Your Allotment request has been rejected for: '.$Proptitle.' Property.
                  </div>
                          </div>
    ...
    $mail->AltBody = 'Your Allotment Request has been rejected';
...
<form id ="form" name="Registration" method="post" action="allotedit1.php">
   ...
   <tr>
     ...
     <input type='submit'  name = 'submit' value = 'Reject Request' class="btn"  align='center' colspan='6'>
     <?php 
