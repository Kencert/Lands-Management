		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container" >
		                <div class="card wizard-card" data-color="blue" id="wizard" >
			                   <form id = "formpost" role="form" action = "allotmentsave.php"  method = "post">
	                    	<div class="wizard-header">
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="location">
		                            	<div class="row">
		                                	<div class="col-sm-12">
		                                    	<h4 class="info-text">Bio-data</h4>
		                                	</div>
		                                	<div class="col-sm-4 ">
		                            ...
		                            <div class="tab-pane" id="type">
		                                ...
		                                <div class="row">
		                                  ...
		                                  <div class="col-sm-4">
		                                        ...
		                                        <div class="col-sm-4">
		                                          <div class="form-group label-floating">
		                                        	<label class="control-label">Allot type.</label>
	                                            	<select name="allottype" class="form-control"><option>Lease</option><option>Buy</option> </select>
	                                            	</div>
		                        ...
		                        <a href="index.php" class="btn btn-next btn-fill btn-primary btn-wd">Home Here</a>
	                            	<div class="pull-right">
	                                    ...
	                                    <input type='submit' name = 'submit' value = 'Request' class="btn btn-finish btn-fill btn-primary btn-wd"/>
	                                </div>
	                                <div class="pull-left">
