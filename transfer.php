		        ...
		        <div class="col-sm-8 col-sm-offset-2">
		            ...
		            <div class="wizard-container" >
		                <div class="card wizard-card" data-color="blue" id="wizard" >
			                   <form id = "formpost" role="form" action = "transfersave.php"  method = "post">
	                    	<div class="wizard-header">
								...
								<div class="wizard-navigation">
									<ul>
			                            ...
			                            <li><a href="#description" data-toggle="tab">Bio Data Details</a></li>
		                        ...
		                        <div class="tab-content">
		                            <div class="tab-pane" id="location">
		                            	<div class="row">
		                                	<div class="col-sm-12">
		                                    	<h4 class="info-text">Previous Owners Bio-data</h4>
		                                	</div>
		                                	<div class="col-sm-4 ">
		                             ...
		                             <div class="tab-pane" id="description">
		                            	<div class="row">
		                                	<div class="col-sm-12">
		                                    	<h4 class="info-text">Transfer Owners Bio-data</h4>
		                                	</div>
		                                	<div class="col-sm-4 ">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">First Name</label>
													<input type='text'  name = 'txttfname' class="form-control"" />
               										</div>
		                                	</div>
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                           <label class="control-label">Last Name</label>
	                                            	<input type='text'  name = 'txttlname' class="form-control" " />
		                                	...
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">Full Name</label>
	                                            	<input type='text'  name = 'txttfullname' class="form-control"" />
		                                	...
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">Address</label>
	                                            	<input type='text'  name = 'txttaddress' class="form-control"" />
	                                            	</div>
		                                	</div>
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">National ID/Passport No.</label>
	                                            	<input type='text'  name = 'txttid' class="form-control"" />
	                                            	</div>
		                                	</div>
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">Email Address</label>
	                                            	<input type='email'  name = 'txttemail' class="form-control"" />
	                                            	</div>
		                                	</div>
		                                	<div class="col-sm-4">
		                                    	<div class="form-group label-floating">
		                                        	<label class="control-label">Mobile Number</label>
	                                            	<input type='text'  name = 'txttmobile' class="form-control"" />
	                                            	</div>
		                                	</div>
		                                	<div class="col-sm-4">
		                                          <div class="form-group label-floating">
		                                        	<label class="control-label">Nationality</label>
	                                            	<input type='text'  name = 'txttnation' class="form-control" " />
	                                            	</div>
		                                  ...
		                                  <div class="col-sm-4">
		                                        ...
		                                        <div class="col-sm-4">
		                                          <div class="form-group label-floating">
	                                            	...
	                                            	<input type='text' class="form-control" name = 'txtblock' />
	                                            	</div>
		                                ...
		                                <div class="row">
		                                  ...
		                                  <div class="col-sm-4">
		                                        ...
		                                        <div class="col-sm-4">
		                                          <div class="form-group label-floating">
	                                            	...
	                                            	<input type='text' class="form-control" name = 'txtkinbox' />
	                                            	</div>
		                                  ...
		                                  <div class="col-sm-4">
		                                          <div class="form-group label-floating">
	                                            	...
	                                            	<input type='text' class="form-control" name = 'txtkincode' />
	                                            	</div>
		                                        ...
		                                        <div class="col-sm-4">
		                                          <div class="form-group label-floating">
	                                            	...
	                                            	<input type='text' class="form-control" name = 'txtkinnation' />
	                                            	</div>
